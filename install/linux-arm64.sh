...
# Bob AI installer — Linux aarch64
# Usage:
#   One-liner:  curl -fsSL https://raw.githubusercontent.com/nilcaream/bobai/main/install/linux-arm64.sh | bash
#   From clone: ./install/linux-arm64.sh

readonly BUN_VERSION="1.3.3"
readonly BUN_SHA256="41b9f4f25256db897c2c135320e4f96c373e20ae6f06d8015187dac83591efc8"
readonly BUN_ARCHIVE="bun-linux-aarch64.zip"
readonly BOBAI_PLATFORM="linux-arm64"
...
export BOBAI_PLATFORM="linux-arm64"
