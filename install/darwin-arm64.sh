...
# Bob AI installer — macOS ARM64 (Apple Silicon)
# Usage:
#   One-liner:  curl -fsSL https://raw.githubusercontent.com/nilcaream/bobai/main/install/darwin-arm64.sh | bash
#   From clone: ./install/darwin-arm64.sh

readonly BUN_VERSION="1.3.3"
readonly BUN_SHA256="f50f5cc767c3882c46675fbe07e0b7b1df71a73ce544aadb537ad9261af00bb1"
readonly BUN_ARCHIVE="bun-darwin-aarch64.zip"
readonly BOBAI_PLATFORM="darwin-arm64"
...
export BOBAI_PLATFORM="darwin-arm64"
