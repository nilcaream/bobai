...
# Bob AI installer — Linux x86_64
# Usage:
#   One-liner:  curl -fsSL https://raw.githubusercontent.com/nilcaream/bobai/main/install/linux-x64.sh | bash
#   From clone: ./install/linux-x64.sh
...
readonly BOBAI_PLATFORM="linux-x64"
...
export BOBAI_PLATFORM="linux-x64"
