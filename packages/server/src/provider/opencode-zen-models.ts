...
export const CURATED_OPENCODE_ZEN_MODELS: OpenCodeZenModelConfig[] = [
	...
	{ id: "gpt-5.4", name: "GPT-5.4", contextWindow: 272000, maxOutput: 64000, label: "beta", enabled: true },
	{ id: "gpt-5.4-mini", name: "GPT-5.4 Mini", contextWindow: 272000, maxOutput: 64000, label: "beta", enabled: true },
	{ id: "gpt-5.2", name: "GPT-5.2", contextWindow: 264000, maxOutput: 64000, label: "beta", enabled: true },
