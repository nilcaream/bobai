...
export function getOpenCodeGoAuth(store: AuthStore): OpenCodeGoAuth | undefined {
...
export function setOpenCodeGoAuth(store: AuthStore, auth: OpenCodeGoAuth): AuthStore {
	return {
		...store,
		providers: {
			...store.providers,
